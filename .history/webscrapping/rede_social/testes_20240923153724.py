...
def analyze_sentiment_vader(text):
    ...
    return sentiment['compound']  # Usar o valor composto como indicador

# Adicionando a análise de sentimento a cada post
for post in data:
    if 'comentário' in post:  # Verifica se a chave 'comentário' existe
        post['sentiment'] = analyze_sentiment_vader(post['comentário'])
    else:
